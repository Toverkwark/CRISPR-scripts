...
echo Processing $1
if [ ! -f /home/NKI/b.evers/output/$1.qualities.4 ]; then

	#First, obtain all valid protospacers for this particular refseq
	echo 'Find all protospacers for' $1
	perl /home/NKI/b.evers/CRISPR/ObtainValidProtospacersFromRefSeq.pl -r $1 -o /home/NKI/b.evers/output/$1.protospacers
	...
	bowtie2 /home/NKI/b.evers/hg19-index/hg19 -r /home/NKI/b.evers/output/$1.protospacers -t -S /home/NKI/b.evers/output/$1.matched --no-hd --score-min L,-5,0 -k 2 --mm
	...
	perl /home/NKI/b.evers/CRISPR/IdentifyIdenticalTargetSites.pl -i /home/NKI/b.evers/output/$1.matched -o /home/NKI/b.evers/output/$1.qualities
	...
	perl /home/NKI/b.evers/CRISPR/QualityScoreSites.pl -i /home/NKI/b.evers/output/$1.qualities -o /home/NKI/b.evers/output/$1.qualities.0 -d 0 -s 12 
	...
	perl /home/NKI/b.evers/CRISPR/QualityScoreSites.pl -i /home/NKI/b.evers/output/$1.qualities.0 -o /home/NKI/b.evers/output/$1.qualities.1 -d 1 -s 20 -l
	echo 'Find 2MM relatives for' $1
	perl /home/NKI/b.evers/CRISPR/QualityScoreSites.pl -i /home/NKI/b.evers/output/$1.qualities.1 -o /home/NKI/b.evers/output/$1.qualities.2 -d 2 -s 20
	echo 'Find 3MM relatives for' $1
	perl /home/NKI/b.evers/CRISPR/QualityScoreSites.pl -i /home/NKI/b.evers/output/$1.qualities.2 -o /home/NKI/b.evers/output/$1.qualities.3 -d 3 -s 20
	echo 'Find 4MM relatives for' $1
	perl /home/NKI/b.evers/CRISPR/QualityScoreSites.pl -i /home/NKI/b.evers/output/$1.qualities.3 -o /home/NKI/b.evers/output/$1.qualities.4 -d 4 -s 20

	#Clean up intermediate files
	echo 'Clean up intermediate files for' $1
	rm /home/NKI/b.evers/output/$1.protospacers
	rm /home/NKI/b.evers/output/$1.matched
	rm /home/NKI/b.evers/output/$1.qualities
	rm /home/NKI/b.evers/output/$1.qualities.0
	rm /home/NKI/b.evers/output/$1.qualities.1
	rm /home/NKI/b.evers/output/$1.qualities.2
	rm /home/NKI/b.evers/output/$1.qualities.3

	cp /home/NKI/b.evers/output/$1.qualities.4 /home/NKI/b.evers/yproblem
	#Convert the protospacers found into BED files
	#perl CreateBEDFile.pl -i output/$1.qualities.4 -o output/$1.BED
fi
